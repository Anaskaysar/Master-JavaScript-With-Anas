...
const score1El = document.getElementById('score--1') //little bit faster than query selector
...
const init = function () {
    ...
    playerOne.classList.remove('player-activate');

}
init();
//Common Functions to follow DRY method
